...
const createReportData = (overrides: Partial<SafeguardingReportData> = {}): SafeguardingReportData => ({
  ...
  reporterNature: 'I witnessed this happening',
  reporterConsent: true,
  category: 'Physical Abuse',
  incidentDate: '2024-01-01',
  location: 'Community Center',
  personAtRiskName: 'Test Person',
  personAtRiskAge: '18-25',
  personAtRiskGender: 'Unknown',
  personAtRiskIsParticipant: 'Unknown',
  allegedPerpetratorName: 'Other Person',
  allegedPerpetratorRole: 'Unknown',
  isPersonAtRiskInContact: 'Unknown',
